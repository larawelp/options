...
use LaraWelP\Contracts\Options\OptionsForm as OptionsFormContract;
...
class OptionsForm implements OptionsFormContract
{
    ...
    {
        /** @var \LaraWelP\Contracts\Options\OptionsFieldGenerator $generator */

        $generatorClassName = '\\LaraWelP\\Options\\OptionsFieldGenerator\\' . ucfirst($type) . 'FieldGenerator';
