...
namespace LaraWelP\Options;

use InvalidArgumentException;
use LaraWelP\Contracts\Options\OptionsField as OptionsFieldContract;
use LaraWelP\Contracts\Options\OptionsPage as OptionsPageContract;
use LaraWelP\Contracts\Options\OptionsSection as OptionsSectionContract;
...
class OptionsField implements OptionsFieldContract
{
    ...
    final public function register($optionsPage, $optionsSection, $optionGroup, $optionName, $hook = true)
    {
        ...
        if ($this->renderFunction) {
            ...
            $optionsFieldGeneratorClassName = '\\LaraWelP\\Options\\OptionsFieldGenerator\\' . ucfirst(strtolower($this->type())) . 'FieldGenerator';

            if ( ! class_exists($optionsFieldGeneratorClassName)) {
                throw new InvalidArgumentException("Invalid field type `{$field->type()}`.");
            }

            /** @var \LaraWelP\Contracts\Options\OptionsFieldGenerator $optionsFieldGenerator */
